...
.table-wrapper-scroll-y {
	display: block;
		...
		<div class="item1"
			...
			<form action="security.jsp" method="get">
				<label>Recorded Voice Samples</label> <br> <input
					list="browsers">
				...
				<button type="submit" formaction="security.jsp">Record new
					sample</button>
				<button type="submit" formaction="security.jsp">Delete
					sample</button>
