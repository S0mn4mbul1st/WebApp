...
.checkboxes label {
	margin: 0px 20px 0px;
			...
			<div class="checkboxes">
				<span> <input type="checkbox" name="Mow" value="Mow">
					<input type="checkbox" name="Weedeat" value="Weedeat"> <input
					type="checkbox" name="Edge" value="Edge">
				</span>
			</div>
...
.radio {
	...
	*filter: progid:DXImageTransform.Microsoft.dropshadow(OffX=-1, OffY=0,
		color=#F0FFF0) progid:DXImageTransform.Microsoft.dropshadow(OffX=1,
		OffY=0, color=#FF0000) progid:DXImageTransform.Microsoft.dropshadow(OffX=0,
		OffY=-1, color=#FF0000) progid:DXImageTransform.Microsoft.dropshadow(OffX=0,
		OffY=1, color=#FF0000); /* IE6, IE7 */
}
</style>
			...
			<form action="">
				<label class="form-control"> <input type="radio"
					...
					name="radio" checked /> Kitchen
				</label> <label class="form-control"> <input type="radio"
					name="radio" checked /> Bedroom A
				</label> <label class="form-control"> <input type="radio"
					name="radio" checked /> Bedroom B
				</label> <label class="form-control"> <input type="radio"
					name="radio" checked /> Bedroom C
				</label> <label class="form-control"> <input type="radio"
					name="radio" checked /> Bedroom D
				</label>
			</form>
